---
layout: post
title: "HTML 기본 구조 완전 정리 — DOCTYPE, html, head, body"
description: "모든 HTML 파일이 공통으로 가져야 하는 기본 구조를 설명합니다. DOCTYPE 선언, html 태그, head와 body의 차이, charset과 viewport 설정까지 하나씩 짚어봅니다."
date: 2015-01-02 09:00:00 +0900
category: html
level: beginner
...
HTML 파일을 처음 만들면 늘 같은 틀로 시작합니다. 이 틀이 왜 필요한지, 각 줄이 무슨 역할을 하는지 모르고 복사해서 쓰는 경우가 많습니다. 이 글에서는 그 구조를 하나씩 분해해서 설명합니다.
...
head 안에 들어가는 것들을 정리하면 다음과 같습니다.
...
브라우저 탭에 표시되는 제목입니다. 검색 결과에도 그대로 노출되기 때문에 SEO에서 매우 중요합니다. 핵심 키워드를 앞에 배치하고 30자 이내로 작성하는 것이 좋습니다.
