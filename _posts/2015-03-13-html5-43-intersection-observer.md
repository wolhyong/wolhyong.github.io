---
layout: post
title: "Intersection Observer 완전 정리 — 스크롤 애니메이션, 지연 로딩, 무한 스크롤"
description: "Intersection Observer API로 요소가 뷰포트에 들어오는 시점을 감지하는 방법을 정리합니다. threshold·rootMargin 옵션, 스크롤 등장 애니메이션, 이미지 지연 로딩 직접 구현, 무한 스크롤, 광고 노출 시간 측정 패턴까지 실전 예제와 함께 다룹니다."
date: 2015-03-13 09:00:00 +0900
category: html
level: advanced
