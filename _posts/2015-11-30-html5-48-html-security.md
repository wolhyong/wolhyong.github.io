---
layout: post
title: "HTML 보안 기초 — XSS 방어, CSP 헤더, CSRF, 안전한 HTML 작성"
description: "HTML 보안 - XSS와 CSRF는 어떻게 방어하나요? XSS(크로스 사이트 스크립팅) 공격 원리와 방어법, Content Security Policy(CSP) 헤더 설정, CSRF 토큰, 클릭재킹 방지, Subresource Integrity(SRI)까지 다룹니다."
