---
layout: post
title: "Service Worker 완전 정리 — 오프라인 캐싱, 네트워크 전략, 업데이트 처리"
description: "Service Worker의 생명주기(install·activate·fetch)를 설명하고 Cache API로 오프라인 캐싱을 구현하는 방법을 정리합니다. Cache First, Network First, Stale-While-Revalidate 전략 비교, 오래된 캐시 삭제, 워커 업데이트 처리, Workbox 소개까지 다룹니다."
date: 2015-03-05 09:00:00 +0900
category: html
level: advanced
...
- Workbox를 사용하면 복잡한 캐싱 로직을 훨씬 간단하게 구현할 수 있습니다
