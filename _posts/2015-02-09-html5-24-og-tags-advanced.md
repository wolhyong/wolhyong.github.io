---
layout: post
title: "Open Graph 태그 심화 — 카카오톡·슬랙·트위터 공유 썸네일 최적화 실전"
description: "OG(Open Graph) 태그를 완전히 활용해 SNS 공유 미리보기를 최적화하는 방법을 정리합니다. og:image 권장 크기, article 전용 태그, 트위터 카드 타입별 차이, Jekyll 블로그에 OG 태그 자동화하는 방법, og:image 크롤러 캐시 갱신법까지 다룹니다."
date: 2015-02-09 09:00:00 +0900
category: html
level: intermediate
...
블로그 글 링크를 카카오톡이나 슬랙에 공유했을 때 제목, 설명, 이미지가 예쁘게 나오는 것은 OG 태그 덕분입니다. 초급에서 기초를 다뤘으니 이번에는 실전에서 자주 마주치는 상황들을 심화로 정리합니다.
...
<meta name="twitter:title" content="Python 가상환경 완전 정리">
...
```yaml
---
title: "Python 가상환경 완전 정리"
description: "venv, conda, poetry 세 가지 방법을 비교합니다."
...
다음 글에서는 구조화 데이터 — Schema.org와 JSON-LD로 리치 스니펫 만들기를 다룹니다.